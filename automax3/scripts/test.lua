...
freeswitch.consoleLog("INFO", "Agent id is: " .. activeuser .. "\n")
local reguser = activeuser:find("error")

-- Determine if registered
local is_registered = (reguser == nil)  -- nil means "error" NOT found = user IS registered

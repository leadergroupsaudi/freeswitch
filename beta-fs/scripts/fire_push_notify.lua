...
-- create Call Log for IP-Phone calls
	...
	if session:getVariable("sip_h_X-CallLogId") == nil and ( string.find(sip_user_agent, "MicroSIP") or string.find(sip_user_agent, "PortSIP") or string.find(sip_user_agent,"EGW Sv1.88.0") or string.find(sip_user_agent, "Z 5.5.14") or string.find(sip_user_agent, "Cisco") ) then

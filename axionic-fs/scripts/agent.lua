...
while true do
	...
	freeswitch.consoleLog("INFO", "Calltype from event: " .. tostring(calltype) .. "\n")
...
local callee_joined_at = 'null'
  caller_left_at = 'in_call';
      ...
      if cause == "NORMAL_CLEARING" then return end
          if callee_number  and #callee_number < 4 and (cause == "NO_ANSWER" or  cause == "USER_BUSY") then 
